...
- **как разрешился приватный лидерборд** — постскриптум §10 с числами топ-решений: победитель поднялся с 344-го на 1-е, доверившись CV, а 92 модели дали лишь +0.0004 — всё по прогнозу секции.
